...
// Bonus test
twoway ///
    (bar abs_did pos if test == "Bonus" & model == "gpt-4o", ///
	...
	(bar abs_did pos if test == "Bonus" & model == "deepseek-r1-671b", ///
...
// Punishment test  
twoway ///
    (bar abs_did pos if test == "Punishment" & model == "gpt-4o", ///
        barwidth(0.7) color("`color_gpt'") lcolor(gs8) lwidth(0.3)) ///
    (bar abs_did pos if test == "Punishment" & model == "qwen-turbo", ///
        barwidth(0.7) color("`color_qwen'") lcolor(gs8) lwidth(0.3)) ///
		(bar abs_did pos if test == "Punishment" & model == "deepseek-r1-671b", ///
        barwidth(0.7) color("`color_deepseek'") lcolor(gs8) lwidth(0.3)) ///
...
// Policy test
twoway ///
    (bar abs_did pos if test == "Policy" & model == "gpt-4o", ///
        barwidth(0.7) color("`color_gpt'") lcolor(gs8) lwidth(0.3)) ///
    (bar abs_did pos if test == "Policy" & model == "qwen-turbo", ///
	        barwidth(0.7) color("`color_qwen'") lcolor(gs8) lwidth(0.3)) ///
    (bar abs_did pos if test == "Policy" & model == "deepseek-r1-671b", ///
        barwidth(0.7) color("`color_deepseek'") lcolor(gs8) lwidth(0.3)) ///
