...
Use sections 1 and 2 of the package-root README.md for the tested dependency versions and installation commands, including the bundled ftools, reghdfe and ivreghdfe sources. Run those commands from the directory containing run.do (one level above this Fig 4 folder).
