...
CONFIG = {
    ...
    'max_retries': 2,
    'retry_delay': 10,
    'input_dir': str(Path(__file__).resolve().parents[1] / "outputs" / "processing_without_private"),
    'save_dir': str(Path(__file__).resolve().parents[1] / "outputs" / "processing_without_private"),
    'temp_dir': str(Path(__file__).resolve().parents[1] / "outputs" / "processing_without_private"),
    'today': "2023-10-30",
    'small_sample': 1,
    'sample_size': 2000,
